...
$loginmodule = JCmsExtensionHelperModule::getModule('mod_login');

echo JCmsExtensionHelperModule::renderModule($loginmodule, array('style' => 'rounded', 'id' => 'section-box'));
...
$modules = JCmsExtensionHelperModule::getModules('login');

foreach ($modules as $module) :
	// Render the login modules
	if ($module->module != 'mod_login') :
		echo JCmsExtensionHelperModule::renderModule($module, array('style' => 'rounded', 'id' => 'section-box'));
	endif;
endforeach;

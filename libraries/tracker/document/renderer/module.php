...
class JDocumentRendererModule extends JDocumentRenderer
{
	...
	public function render($module, $attribs = array(), $content = null)
	{
		if (!is_object($module))
		{
			...
			$module = JCmsExtensionHelperModule::getModule($module, $title);
		...
		if ($params->get('cache', 0) == 1 && $conf->get('caching') >= 1 && $cachemode != 'id' && $cachemode != 'safeuri')
		{
			...
			$contents = JCmsExtensionHelperModule::ModuleCache($module, $params, $cacheparams);

		}
		else
		{
			$contents = JCmsExtensionHelperModule::renderModule($module, $attribs);
		}
